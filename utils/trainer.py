...
class Trainer:
    ...
    def __init__(self, model, loss, optimizer, name=None, clip_gradient=None, checkpoint_userdata=None):
        ...
        :param model: The models to use. It must inherit from models abstract class. :class:`models.models.Model`
        :param loss: The loss to use. It must inherit from loss abstract class. :class:`models.loss.loss.Loss`
